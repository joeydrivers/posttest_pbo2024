...
interface Pembayaran {
    ...
    boolean cekStatusPembayaran();
}

abstract class TiketPenumpang {
    private String nama;
...
class TiketBiasa extends TiketPenumpang implements Pembayaran {
    ...
    public void tampilkanInfo() {
        ...
        System.out.println("Tanggal dan Jam Keberangkatan: " + getTanggalJamKeberangkatan());
        System.out.println("Harga Tiket Biasa: " + harga);
    }
    ...
    public void prosesPembayaran(int totalHarga) {
        if (!statusPembayaran) {
            ...
            System.out.println("Pembayaran telah dilakukan sebelumnya.");
        }
    }
...
class TiketVIP extends TiketPenumpang {
    ...
    public void tampilkanInfo() {
        ...
        System.out.println("Umur: " + getUmur());
        System.out.println("Tanggal dan Jam Keberangkatan: " + getTanggalJamKeberangkatan());
        System.out.println("Fasilitas Tiket VIP: " + fasilitas);
    }
}

public class App {
    private static final ArrayList<TiketPenumpang> dataPenumpang = new ArrayList<>();
        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Total Pendapatan: $" + TiketBiasa.getTotalPendapatan());
                    break;
                case 6:
